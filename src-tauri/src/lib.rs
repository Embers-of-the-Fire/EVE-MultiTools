...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            data::localization::get_ui_localization_by_language,
            data::localization::type_lookup::search_type_by_name,
            data::localization::type_lookup::search_type_by_description,
            data::localization::universe_lookup::search_region_by_name,
            data::localization::universe_lookup::search_constellation_by_name,
            data::localization::universe_lookup::search_system_by_name,
            data::localization::npc_corporation_lookup::search_npc_corporation_by_name,
            data::market::get_market_price,
            data::universe::regions::get_region_by_id,
            data::universe::regions::get_regions_by_faction_id,
            data::universe::regions::get_regions_by_wormhole_class_id,
            data::universe::regions::get_region_detail_by_id,
            data::universe::constellations::get_constellation_by_id,
            data::universe::constellations::get_constellations_by_region_id,
            data::universe::constellations::get_constellations_by_faction_id,
            data::universe::constellations::get_constellations_by_wormhole_class_id,
            data::universe::constellations::get_constellation_detail_by_id,
            data::universe::systems::get_system_by_id,
            data::universe::systems::get_systems_by_constellation_id,
            data::universe::systems::get_systems_by_region_id,
            data::universe::systems::get_systems_by_faction_id,
            data::universe::systems::get_systems_by_security_range,
            data::universe::systems::get_systems_by_wormhole_class_id,
            ...
            data::universe::system_content::npc_stations::get_npc_station_by_id,
            data::universe::system_content::npc_stations::get_npc_station_data_by_id,
        ])
